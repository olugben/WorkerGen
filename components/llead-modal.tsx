...
export function LLeadModal({ open, onClose }: LeadModalProps) {
  return (
    ...
    {/* Dialog Content */}
    <DialogContent className="fixed inset-x-4 top-16 md:inset-x-auto md:top-auto md:left-1/2 transform md:-translate-x-1/2 max-w-3xl p-6 md:p-8 bg-gradient-to-br from-white to-slate-50 shadow-lg rounded-lg z-50 overflow-auto">
